...
export class MathUtils {
  ...
  static pointInSphere(point, sphereCenter, sphereRadius) {
    return (
      MathUtils.distanceSquared(point, sphereCenter) <=
  ...
  static sphereBoxCollision(sphereCenter, sphereRadius, boxMin, boxMax) {
    ...
    return (
      MathUtils.distanceSquared(sphereCenter, closestPoint) <=
      sphereRadius * sphereRadius
    );
  }
  ...
  static noise(x, y = 0, z = 0) {
    ...
    return MathUtils.lerp(
      MathUtils.lerp(
        MathUtils.lerp(
          MathUtils.grad(MathUtils.p[AA], x, y, z),
          MathUtils.grad(MathUtils.p[BA], x - 1, y, z),
          u,
        ),
        MathUtils.lerp(
          MathUtils.grad(MathUtils.p[AB], x, y - 1, z),
          MathUtils.grad(MathUtils.p[BB], x - 1, y - 1, z),
          u,
        ),
        v,
      ),
      MathUtils.lerp(
        MathUtils.lerp(
          MathUtils.grad(MathUtils.p[AA + 1], x, y, z - 1),
          MathUtils.grad(MathUtils.p[BA + 1], x - 1, y, z - 1),
          u,
        ),
        MathUtils.lerp(
          MathUtils.grad(MathUtils.p[AB + 1], x, y - 1, z - 1),
          MathUtils.grad(MathUtils.p[BB + 1], x - 1, y - 1, z - 1),
          u,
        ),
        v,
      ),
